...
/** Days a new process's history is kept by default (`camunda:historyTimeToLive`). */
export const DEFAULT_HISTORY_TIME_TO_LIVE_DAYS = 7;

/** Blank diagram: an executable process with an initial history time to live. */
...
<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:camunda="http://camunda.org/schema/1.0/bpmn" id="Definitions_1" targetNamespace="http://bpmn.io/schema/bpmn">
  <bpmn:process id="Process_1" isExecutable="true" camunda:historyTimeToLive="${DEFAULT_HISTORY_TIME_TO_LIVE_DAYS}">
...
export async function newDiagram(): Promise<ImportXMLResult> {
    return getModeler().importXML(INITIAL_DIAGRAM);
}
